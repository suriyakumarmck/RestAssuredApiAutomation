...
public class RestAssuredHelper {
    ...
    private ResponseOptions<Response> ExecuteAPI() throws URISyntaxException {
        ...
        if (this.method.equalsIgnoreCase(FrameworkConstants.POST)) {
            return request.post(new URI(this.url));
        } else if (this.method.equalsIgnoreCase(FrameworkConstants.DELETE)) {
            return request.delete(new URI(this.url));
        } else if (this.method.equalsIgnoreCase(FrameworkConstants.GET)) {
